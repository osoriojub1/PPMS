...
// Mock system health data (mirrored from Admin for consistency)
                    ...
                    <div className="bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden">
                        ...
                        <div className="p-6">
                            <div className="grid grid-cols-3 gap-4">
                                ...
                                >
                                    <div className={`h-14 w-14 rounded-full mx-auto mb-4 flex items-center justify-center transition-all ${darkMode === 'light' ? 'bg-green-600 text-white' : 'bg-gray-100 text-gray-400 group-hover:bg-gray-200'
                                        }`}>
                                        <Sun size={24} />
                                    </div>
                                ...
                                <button
                                    ...
                                    className={`relative p-6 rounded-2xl border-2 transition-all text-center group ${darkMode === 'dark'
                                        ? 'border-green-600 bg-gray-900 shadow-lg shadow-green-100'
                                        : 'border-gray-200 bg-white hover:border-gray-400'
                                        }`}
                                >
                                    <div className={`h-14 w-14 rounded-full mx-auto mb-4 flex items-center justify-center transition-all ${darkMode === 'dark' ? 'bg-green-600 text-white' : 'bg-gray-100 text-gray-400 group-hover:bg-gray-200'
                                        }`}>
                                        <Moon size={24} />
                                    </div>
                                ...
                                >
                                    <div className={`h-14 w-14 rounded-full mx-auto mb-4 flex items-center justify-center transition-all ${darkMode === 'system' ? 'bg-green-600 text-white' : 'bg-gray-100 text-gray-400 group-hover:bg-gray-200'
                                        }`}>
                                        <Monitor size={24} />
                                    </div>
                            ...
                            <div className="mt-6 p-4 bg-green-50 rounded-xl border border-green-100 flex items-start space-x-3">
            ...
            {activeSection === 'health' && (
                <div className="space-y-6">
                    ...
                    <div className="grid grid-cols-4 gap-4">
                        {[
                            { label: 'Active Users', value: mockSystemHealth.metrics.activeUsers, icon: <Wifi size={18} />, color: 'green' },
                            { label: 'Total Patients', value: mockSystemHealth.metrics.totalPatients, icon: <Database size={18} />, color: 'emerald' },
                            { label: 'Pending Referrals', value: mockSystemHealth.metrics.pendingReferrals, icon: <Clock size={18} />, color: 'amber' },
                            { label: 'Scheduled Labs', value: mockSystemHealth.metrics.scheduledLabs, icon: <HardDrive size={18} />, color: 'teal' },
                        ].map(metric => (
                    ...
                    <div className="grid grid-cols-5 gap-6">
                        ...
                        <div className="col-span-2 bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden">
                            ...
                            <div className="p-5 space-y-6">
                                {[
                                    { label: 'CPU', value: mockSystemHealth.metrics.cpuUsage, color: 'bg-green-500' },
                                    { label: 'Memory', value: mockSystemHealth.metrics.memoryUsage, color: 'bg-emerald-500' },
                                    { label: 'Disk', value: mockSystemHealth.metrics.diskUsage, color: 'bg-teal-500' },
                                ].map(resource => (
